...
const FLOWER_IMAGE = "dist/assets/product-2.png";
const LEAF_IMAGE = "dist/assets/product-1.png";
const MIX_IMAGE = "dist/assets/product-3.png";
const LAVENDER_IMAGE = "dist/assets/product-4.png";
